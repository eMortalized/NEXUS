<form id="parenting" name="parenting">
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            <div class="row">
            <div class="col-sm-12">
                <label class="custom-display" for="children"><input type="checkbox" icheck id="children" name="children" ng-model="child"> Children <a href="" class="tooltip-help_custom pull-right"  data-placement="top" data-title="Select yes if there is at least one child."><i class="fa fa-info-circle"></i></a></label>
            </div>
            <!--<div class="col-sm-12 noPadding">
...
<div class="form-group">
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            <div class="row">
            <div class="col-sm-12">
                <label class="custom-display" for="parentingImportant">The most important lesson for my children is... <label for="parentingImportant_upload" class="custom-file-upload">
                        <i class="fa fa-arrow-circle-up"  data-placement="top" data-title="Upload"></i>
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            <div class="row">
            <div class="col-sm-12">
                <label class="custom-display" for="grandchildren"><input type="checkbox" icheck id="grandchildren" name="grandchildren" ng-model="grandchild"> Grand children <a href="" class="tooltip-help_custom pull-right"  data-placement="top" data-title="Select yes if there is at least one grandchild."><i class="fa fa-info-circle"></i></a></label>
            </div>
        ...
        <div class="form-group">
            <div class="row">
            <div class="col-sm-12">
                <label class="custom-display" for="grandchild">Grand child <a href="" class="tooltip-help_custom pull-right"  data-placement="top" data-title="Input the proper name for the grandchild."><i class="fa fa-info-circle"></i></a></label>
            </div>
            <div class="col-sm-12 noPadding">
