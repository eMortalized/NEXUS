<form id="parenting" name="parenting">
    ...
    <div class="col-md-4">
        <div class="arrayFields" ng-show="child">  
            <!-- Array Head -->
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            <div class="row">
            <div class="col-sm-12">
                <label class="custom-display" for="grandchildren"><input type="checkbox" icheck id="grandchildren" name="grandchildren" ng-model="grandchild"> Grand children</label>
            </div>
