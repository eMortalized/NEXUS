<form id="favourites" name="favourites">

    <div class="col-sm-12 text-center top">
        <h2>Favourites {{test}}</h2>
    </div>
    <!-- Col 1 -->
    <div class="col-md-4">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-sm-12 noPadding">
                    <select id="country" data-placeholder="Type or select country name" class="chosen-select form-control" multiple tabindex="4" name="country" >
                        <option value=""></option>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <label class="custom-display" for="countryNarrative">Country narrative <label for="countryNarrative_upload" class="custom-file-upload">
                            <i class="fa fa-arrow-circle-up"  data-placement="top" data-title="Upload"></i>
                        </label><input type="file" id="countryNarrative_upload" name="countryNarrative_upload"/><a href="" class="tooltip-help_custom pull-right"  data-placement="top" data-title="Compose a brief narrative to describe why it is a favourite."><i class="fa fa-info-circle"></i></a></label>
                </div>
                <div class="col-sm-12 noPadding">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    <label class="custom-display" for="colour">Colour <label for="colour_upload" class="custom-file-upload">
                            <i class="fa fa-arrow-circle-up"  data-placement="top" data-title="Upload"></i>
                        </label><input type="file" id="colour_upload" name="colour_upload"/><a href="" class="tooltip-help_custom pull-right"  data-placement="top" data-title="Enter a favourite colour."><i class="fa fa-info-circle"></i></a></label>
                </div>
                <div class="col-sm-12 noPadding">
                    <select class="form-control chosen-select" id="colour" name="colour">
                        <option> </option>
                        ...
                        <option>Black</option>
                        <option>Blue</option>
                        <option>Blue, baby</option>
                        <option>Blue, cobalt</option>
                        <option>Blue, electric</option>
                        <option>Blue, navy</option>
                        <option>Blue, persian</option>
                        <option>Blue, prussian</option>
                        <option>Blue-green</option>
                        <option>Blue-violet</option>
                        <option>Blush</option>
                        <option>Bronze</option>
                        <option>Brown</option>
                        <option>Bud, spring</option>
                        ...
                        <option>Gold</option>
                        <option>Gray</option>
                        <option>Gray, slate</option>
                        <option>Green</option>
                        <option>Green, chartreuse</option>
                        <option>Green, jungle</option>
                        <option>Green, spring</option>
        ...
        <div class="arrayFields">
            ...
            <div class="row arrayHead">
                <div class="col-xs-2">
                    <switch name="expressions" ng-model="expressions"></switch>
                </div>
                <div class="col-xs-10 text-right">
                    <span ng-hide="expressions" class="fixPlace">Expressions / Quotes</span>
                </div>
            </div>
            <!-- Array Head -->

            <!-- Array Body -->
            <div class="arrayBody" ng-show="expressions">
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            <label class="custom-display" for="expressions">Expressions / Quotes <label for="expressions_upload" class="custom-file-upload">
                                    <i class="fa fa-arrow-circle-up"  data-placement="top" data-title="Upload"></i>
                                </label><input type="file" id="expressions_upload" name="expressions_upload"/><a href="" class="tooltip-help_custom pull-right"  data-placement="top" data-title="Enter favourite expression or quotation"><i class="fa fa-info-circle"></i></a></label>
                        </div>
                        <div class="col-sm-12 noPadding">
...
<div class="arrayFields"> 
        ...
        <div class="arrayFields">  
            ...
            <div class="row arrayHead">
                <div class="col-xs-2">
                    <switch name="sportsTeams" ng-model="sportsTeams"></switch>
                </div>
                <div class="col-xs-10 text-right">
                    <span ng-hide="sportsTeams" class="fixPlace">Sports team</span>
                </div>
            </div>
            <!-- Array Head -->

            <!-- Array Body -->
            <div class="arrayBody" ng-show="sportsTeams">
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            <label class="custom-display" for="sportsTeams">Sports team <label for="sportsTeams_upload" class="custom-file-upload">
                                    <i class="fa fa-arrow-circle-up"  data-placement="top" data-title="Upload"></i>
                                </label><input type="file" id="sportsTeams_upload" name="sportsTeams_upload"/><a href="" class="tooltip-help_custom pull-right"  data-placement="top" data-title="Select a favourite sports team, one at a time, or type one in if your choice is not in the list.  Type any portion of the name to narrow the list."><i class="fa fa-info-circle"></i></a></label>
                        </div>
                        <div class="col-sm-12 noPadding">
                            <div class="input-group">

                                <select class="form-control chosen-select pull-left" id="sportsTeams" name="sportsTeams">
                                    <option> </option>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            <label class="custom-display" for="levelFandom">Fandom <label for="levelFandom_upload" class="custom-file-upload">
                                    <i class="fa fa-arrow-circle-up"  data-placement="top" data-title="Upload"></i>
                                </label><input type="file" id="levelFandom_upload" name="levelFandom_upload"/><a href="" class="tooltip-help_custom pull-right"  data-placement="top" data-title="Select the level of fandom in this sports team."><i class="fa fa-info-circle"></i></a></label>
                        </div>
                        <div class="col-sm-12 noPadding">
                            <select class="form-control chosen-select" id="levelFandom" name="levelFandom">
                                <option> </option>
                                <option>Awareness</option>
                                <option>Fan of convenience</option>
                                <option>Fair weather fan</option>
                                <option>Casual fan</option>
                                <option>Dedicated fan</option>
                                <option>True fan</option>
                                <option>Big fan</option>
                                <option>Huge fan</option>
                                <option>Massive fan</option>
                                <option>Obsessed fan</option>
                                <option>Insane fanatic</option>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            <label class="custom-display" for="sportsTeamNarrative">Sports team narrative <label for="sportsTeamNarrative_upload" class="custom-file-upload">
                                    <i class="fa fa-arrow-circle-up"  data-placement="top" data-title="Upload"></i>
                                </label><input type="file" id="sportsTeamNarrative_upload" name="sportsTeamNarrative_upload"/><a href="" class="tooltip-help_custom pull-right"  data-placement="top" data-title="Compose a brief narrative to describe why it is a favourite."><i class="fa fa-info-circle"></i></a></label>
                        </div>
                        <div class="col-sm-12 noPadding">
                            <input type="text" class="form-control" id="sportsTeamNarrative" name="sportsTeamNarrative" maxlength="100"/>
                            <a class="add greenBtn pull-right"><i class="fa fa-2x fa-plus-circle"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="arrayFields">
            ...
            <div class="row arrayHead">
                <div class="col-xs-2">
                    <switch name="songs" ng-model="songs"></switch>
                </div>
                <div class="col-xs-10 text-right">
                    <span ng-hide="songs" class="fixPlace">Songs</span>
                </div>
            </div>
            <!-- Array Head -->

            <!-- Array Body -->
            <div class="arrayBody" ng-show="songs">
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            <label class="custom-display" for="songs">Songs <label for="songs_upload" class="custom-file-upload">
                                    <i class="fa fa-arrow-circle-up"  data-placement="top" data-title="Upload"></i>
                                </label><input type="file" id="songs_upload" name="songs_upload"/><a href="" class="tooltip-help_custom pull-right"  data-placement="top" data-title="Enter a favourite song, one at a time."><i class="fa fa-info-circle"></i></a></label>
                        </div>
                        <div class="col-sm-12 noPadding">
        ...
        <div class="arrayFields">  
            ...
            <div class="row arrayHead">
                <div class="col-xs-2">
                    <switch name="tvShows" ng-model="tvShows"></switch>
                </div>
                <div class="col-xs-10 text-right">
                    <span ng-hide="tvShows" class="fixPlace">TV show</span>
                </div>
            </div>
            <!-- Array Head -->

            <!-- Array Body -->
            <div class="tvShows" ng-show="tvShows">

                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            <label class="custom-display" for="tvShows">TV show <label for="tvShows_upload" class="custom-file-upload">
                                    <i class="fa fa-arrow-circle-up"  data-placement="top" data-title="Upload"></i>
                                </label><input type="file" id="tvShows_upload" name="tvShows_upload"/><a href="" class="tooltip-help_custom pull-right"  data-placement="top" data-title="Select a favourite TV show, one at a time, or type one in if your choice is not in the list.  Type any portion of the name to narrow the list."><i class="fa fa-info-circle"></i></a></label>
                        </div>
                        <div class="col-sm-12 noPadding">
                            <div class="input-group">

                                <select class="form-control chosen-select pull-left" id="tvShows" name="tvShows" >
                                    <option> </option>
                                    <?php
                                    $res = mysqli_query($con, "select * from data_tvshows");
                                    while ($rec = mysqli_fetch_array($res)) {
                                        echo "<option>" . $rec['tvshow_name'] . "</option>";
                                    }
                                    ?>
                                </select>
                                <div class="input-group-addon">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <label class="custom-display" for="memoir">Memoir <label for="memoir_upload" class="custom-file-upload">
                            <i class="fa fa-arrow-circle-up"  data-placement="top" data-title="Upload"></i>
                        </label><input type="file" id="memoir_upload" name="memoir_upload"/><a href="" class="tooltip-help_custom pull-right"  data-placement="top" data-title="Enter the wisdom .Enter the wisdom obtained in this area that is legacy to others."><i class="fa fa-info-circle"></i></a></label>
                </div>
                <div class="col-sm-12 noPadding">
